...
import {getExperienta} from "../../../pagina-antrenor/experiencePage/ExperientaApi";
...
const ExperientaReducer: (state: ExperiencesState, action: ActionProps) => ExperiencesState =
    (state, {type, payload}) => {
        switch (type) {
...
export const ExperientaProvider: React.FC<ExperienceProviderProps> = ({children}) => {
    const [state, dispatch] = useReducer(ExperientaReducer, initialStateExperiences);
